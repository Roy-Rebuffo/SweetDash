...
// ── Modal Vista cliente (solo lectura) ────────────────────────────────────────
function VistaClienteModal({ cliente, idx, onClose, onEditar }) {
...
export default function ClientesView({ isMobile = false }) {
  ...
  const [verCliente,  setVerCliente]  = useState(null);   // cliente para vista detalle
